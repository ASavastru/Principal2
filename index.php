...
<head>
    ...
    <script src="Scripts/dateTimeMoment.js" defer></script>
    <meta charset="UTF-8">
    <meta name="viewport"
...
<div>
    <table class="monthName">
        <tr>
            <td style="align-content: start">&#10094</td>
            <td style="align-content: space-between">JULY</td>
            <td style="align-content: end">&#10095</td>
        </tr>
    </table>
</div>
...
<div>
    <table class="employeeTable">
        <tr>
            <td class="employeeTd"><img class="employeeImage" src="Images/emp_1.jpg" alt="employee_1"></td><td class="employeeName">Employee #1</td>
        </tr>
        <tr>
            <td><img class="employeeImage" src="Images/emp_2.jpg" alt="employee_2"></td><td class="employeeName">Employee #2</td>
        </tr>
    </table>
</div>
